      ...
      <div className="border-b border-ink-line">
        <div className="mx-auto max-w-[86rem] px-6 md:px-10 lg:px-16 py-10 md:py-12">
          <p className="display text-[clamp(1.75rem,3.5vw,3rem)] text-paper leading-[1.05] max-w-5xl">
            The gym for people
            <span className="display-italic text-flame"> who don&rsquo;t like gyms.</span>
          </p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-[86rem] px-6 md:px-10 lg:px-16 py-16 md:py-20 grid gap-12 md:grid-cols-12">
        <div className="md:col-span-5">
          ...
          <p className="mt-6 max-w-sm text-paper/65 leading-relaxed">
            The gym for people who don&rsquo;t like gyms. Specialist
            small group strength training in Eastbourne for beginners,
            older adults, and post-rehab clients.
          </p>
